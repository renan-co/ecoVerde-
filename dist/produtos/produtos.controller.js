...
let ProdutosController = class ProdutosController {
    ...
    atualizar(id, dados) {
        const produto = this.produtosService.atualizar(Number(id), dados);
        if (!produto) {
    ...
    remover(id) {
        const removido = this.produtosService.remover(Number(id));
        if (!removido) {
            return { mensagem: 'Produto não encontrado' };
        }
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ProdutosController.prototype, "adicionar", null);
__decorate([
    (0, common_1.Put)(':id'),
